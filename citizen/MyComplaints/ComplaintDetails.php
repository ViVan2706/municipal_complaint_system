...
<head>
    ...
    <style>
        ...
        * {
        ...
        .nav-link { 
            text-decoration: none; color: var(--text-dark); margin-left: 20px; padding: 5px 10px; 
            display: flex; align-items: center; font-size: 0.95rem; border-radius: 4px;
        }
        .nav-link:hover { color: var(--primary-blue); }
        .notifications-badge {
            background-color: var(--danger-red); color: white; border-radius: 50%; padding: 2px 6px;
