...
<body>
    ...
    <main class="dashboard-container">
        ...
        <div class="complaint-tabs">
            <a href="MyComplaintsPend.php" class="tab-button">Pending (<?php echo htmlspecialchars($pending_count); ?>)</a>
            <a href="MyComplaintsComp.php" class="tab-button active-tab">Completed (<?php echo htmlspecialchars($completed_count); ?>)</a>
        </div>
        <div class="complaint-list">
            ...
            <?php else: ?>
                <div class="complaint-card" style="text-align: center; color: var(--text-muted);">
                    <p>No resolved or rejected complaints found in your record.</p>
                </div>
            <?php endif; ?>
